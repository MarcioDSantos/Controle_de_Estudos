        ...
        <html lang="pt-BR">
            ...
            <body>
                ...
                <footer className="rodape">
                    <img className="rodape-imagem-calendario" src={calendar} />
                    <img className="rodape-imagem-checkList" src={checkList}  />
                    <img className="rodape-imagem-cronometro" src={cronometro}  />
                    <img className="rodape-imagem-email" src={email} />
                </footer>
            </body>
        </html>
    </div>
